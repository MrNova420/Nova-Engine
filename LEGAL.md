...
**File:** [`legal/NovaEngine_PrivacyPolicy.pdf`](legal/NovaEngine_PrivacyPolicy.pdf)
...
If you have questions about any of these legal documents:

1. **Read the Documents:** Start with the Human-Readable Summary
2. **Check This Guide:** Use the quick reference above
3. **Open an Issue:** [GitHub Issues](https://github.com/MrNova420/Nova-Engine/issues) for clarification
4. **Contact Us:** For serious legal inquiries, contact the Nova Engine team

---

## 📝 Document Updates

Legal documents may be updated from time to time. When significant changes occur:

- Users will be notified through the platform
- Updated documents will be versioned
...
All legal documents are maintained in this repository:

```
/legal/
├── NovaEngine_AssetStoreTerms.pdf
├── NovaEngine_BrandTrademarkPolicy.pdf
├── NovaEngine_DeveloperLicense.pdf
├── NovaEngine_EULA.pdf
├── NovaEngine_GameLibraryTerms.pdf
├── NovaEngine_HumanSummary.pdf
├── NovaEngine_PrivacyPolicy.pdf
